(function () {
  ...
  if (document.getElementsByTagName("header").length) {
    ...
    var menuTrigger = $header.getElementsByClassName("menu-trigger")[0];
    ...
    $($searchPanel).on("click", ".reset", function (e) {
      $($searchPanel).find('input[role="combobox"]').val("");
    });
    $($searchPanel).on("click", ".fui-keyword-menu .fui-item", function (e) {
  ...
  jquery(".fui-nav-tab .mobile-dropdown").find("button.display").click(function () {
    var menu = jquery(this).next(".fui-menu");
  ...
  function () {
    function FuiCollapse(elem) {
      ...
      this.elem = $(elem);
      this.header = this.elem.find(".collapse-header");
      this.body = this.elem.find(".fui-menu");
      this.open = false;
    ...
    _createClass(FuiCollapse, [{
      key: "doOpen",
      value: function doOpen() {
        this.elem.addClass("is-open");
      }
    }, {
      key: "doClose",
      value: function doClose() {
        this.elem.removeClass("is-open");
      }
    }]);
  ...
  var $dropdowns = $(".fui-dropdown");
  var $collapse = $(".fui-collapse");
  window.FuiCollapses = [];
  window.FuiDropdowns = [];
  $dropdowns.each(function () {
    window.FuiDropdowns.push(new FuiDropdown(this));
  });
  $collapse.each(function (collapse) {
    window.FuiCollapses.push(new FuiCollapse(this));
  });
  $(".collapse-trigger").click(function (e) {
    $(this).find("i").toggleClass("icon-plus icon-minus");
    $(".collapse-body").toggleClass("active");
  });
  $(".fui-collapse").on(".collapse-header", function () {
    $(this).parent(".fui-collapse").toggleClass("is-open");
  });
  $(".emma-service .emma-service-button").click(function (e) {
    $(this).parent().toggleClass("iframe-open");
  });
  $(".emma-service .iframe-header div[role='button']").click(function (e) {
    $(this).parents(".emma-service").toggleClass("iframe-open");
  });
